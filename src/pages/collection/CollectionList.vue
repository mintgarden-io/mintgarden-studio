    ...
    <div>
      <div class="sm:flex sm:items-center">
        <div class="sm:flex-auto">
          <h1 class="text-3xl leading-6 font-medium text-gray-900">My Collections</h1>
          <p class="mt-4 text-sm text-gray-700">Create a collection if you want to group multiple NFTs together.</p>
        </div>
        <div v-if="collectionList.length > 0" class="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
          <router-link
            to="/collections/new"
            type="button"
